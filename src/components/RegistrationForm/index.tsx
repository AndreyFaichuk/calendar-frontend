...
import { Paper, Link, Button, Box, Typography, Grid } from "@material-ui/core";
...
const RegistrationForm: FC = () => {
  const [inputValue, setInputValue] = useState<UserRegistraion>({
    username: "",
    password: "",
    email: ""
  });
  ...
  return (
    <Paper className={classes.root}>
      <Grid container direction="column" spacing={3}>
        ...
        <Grid item>
          <Input value={inputValue.email} label="Email" name="email" onChange={handleInputChange} />
        </Grid>
      </Grid>
      <Box className={classes.buttonWrapper}>
        ...
        <Box className={classes.titleWrapper}>
          ...
          <Link component="button" variant="body2" onClick={() => navigate(RoutesNames.LOGIN)}>
            Login
          </Link>
        </Box>
      </Box>
